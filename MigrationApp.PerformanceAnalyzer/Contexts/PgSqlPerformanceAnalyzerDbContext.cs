...
/// <summary>
/// Postgre контекст PerformanceAnalyzer.
/// </summary>
public class PgSqlPerformanceAnalyzerDbContext : DbContext
{
    public PgSqlPerformanceAnalyzerDbContext(DbContextOptions<PgSqlPerformanceAnalyzerDbContext> options)
        : base(options) { }
