...
/// <summary>
/// Postgre контекст SearchService.
/// </summary>
public class PgSqlSearchServiceDbContext : DbContext
{
    public PgSqlSearchServiceDbContext(DbContextOptions<PgSqlSearchServiceDbContext> options)
        : base(options) { }
